...
export enum WidgetType {
  ...
  Plotter = 'Plotter',
  PracticePoolView = 'PracticePoolView',
  PracticeView3D = 'PracticeView3D',
  SonarView = 'SonarView',
...
export enum MiniWidgetType {
  ...
  PilotAssistPanel = 'PilotAssistPanel',
...
export const isWidgetConfigurable: Record<WidgetType, boolean> = {
  ...
  [WidgetType.PracticePoolView]: false,
  [WidgetType.PracticeView3D]: false,
  [WidgetType.SonarView]: false,
...
export const isMiniWidgetConfigurable: Record<MiniWidgetType, boolean> = {
  ...
  [MiniWidgetType.PilotAssistPanel]: false,
...
export const widgetDefaultSizes: Partial<Record<WidgetType, SizeRect2D>> = {
  ...
  [WidgetType.PracticePoolView]: { width: 0.5, height: 0.35 },
  [WidgetType.PracticeView3D]: { width: 1, height: 1 },
  [WidgetType.SonarView]: { width: 0.3, height: 0.45 },
